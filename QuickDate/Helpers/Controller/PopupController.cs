    ...
    public class PopupController: Object, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        public void DisplayAddPhoneNumber()
        {
            try
            {
                ...
                AddPhoneNumberWindow = new Dialog(ActivityContext, AppSettings.SetTabDarkTheme ? Resource.Style.MyDialogThemeDark : Resource.Style.MyDialogTheme);
        ...
        public void DisplayPremiumWindow()
        {
            ...
            try
            {
                PremiumWindow = new Dialog(ActivityContext, AppSettings.SetTabDarkTheme ? Resource.Style.MyDialogThemeDark : Resource.Style.MyDialogTheme);
        ...
        private void PremiumAdapterOnItemClick(object sender, PremiumAdapterClickEventArgs e)
        {
            try
            {
                ...
                if (position > -1)
                {
                    if (!AppSettings.ShowPaypal && !AppSettings.ShowCreditCard && !AppSettings.ShowBankTransfer && !AppSettings.ShowInAppBilling && !Client.IsExtended)
                        return;
                    ...
                    if (item != null)
                    {
                        ...
                        switch (AppSettings.PaymentsSystem)
                        {
                            ...
                            case PaymentsSystem.JustInAppBillingGoogle when AppSettings.ShowInAppBilling && Client.IsExtended:
