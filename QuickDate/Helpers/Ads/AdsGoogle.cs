...
using Android.Gms.Ads.InStream;
...
#pragma warning restore 618
        ...
        public static void Ad_AppOpenManager(Activity context)
        {
            ...
            {
                var isPro = ListUtils.MyUserInfo?.FirstOrDefault()?.IsPro ?? "0";
                if (isPro == "0" && AppSettings.ShowAdMobAppOpen)
                {
        ...
        { 
            ...
            private class MyUserEarnedRewardListener : Java.Lang.Object, IOnUserEarnedRewardListener
            {
                private RewardedInterstitialAd Rad;
        ...
        public static AdMobRewardedInterstitial Ad_RewardedInterstitial(Activity context)
        {
            ...
            {
                var isPro = ListUtils.MyUserInfo?.FirstOrDefault()?.IsPro ?? "0";
                if (isPro == "0" && AppSettings.ShowAdMobRewardedInterstitial)
                {
                    if (CountRewardedInterstitial == AppSettings.ShowAdMobRewardedInterstitialCount)
                    {
