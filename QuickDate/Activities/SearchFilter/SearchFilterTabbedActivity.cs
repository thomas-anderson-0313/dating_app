...
namespace QuickDate.Activities.SearchFilter
{
    ...
    public class SearchFilterTabbedActivity : BaseActivity, ViewPager.IOnPageChangeListener
    {
        ...
        private void SetUpViewPager(ViewPager viewPager)
        {
            try
            {
                Adapter = new MainTabAdapter(SupportFragmentManager, FragmentStatePagerAdapter.BehaviorResumeOnlyCurrentFragment);
