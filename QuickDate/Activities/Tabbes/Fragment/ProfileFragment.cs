...
namespace QuickDate.Activities.Tabbes.Fragment
{
    public class ProfileFragment : AndroidX.Fragment.App.Fragment
    {
        ...
        private RelativeLayout WalletButton, PopularityButton, UpgradeButton, FavoriteButton, HelpButton, InviteButton, BlogsButton, FriendsButton, LikedButton, DislikedButton, ShareButton;
        ...
        private void LoadDataUser(UserInfoObject data)
        {
            try
            { 
                GlideImageLoader.LoadImage(Activity, data.Avater.PurpleUri, ProfileImage, ImageStyle.CircleCrop, ImagePlaceholders.Drawable);
                GlideImageLoader.LoadImage(Activity, data.Avater.PurpleUri, GlobalContext.FragmentBottomNavigator.ProfileImage, ImageStyle.CircleCrop, ImagePlaceholders.Drawable);
