                ...
                if (item != null)
                {
                    switch (item.Type)
                    {
                        ...
                        case ItemType.Users:
                        {
                            ...
                            {
                                FullGlideRequestBuilder.Load(item.UsersData.Avater.PurpleUri).Into(nearByAdapter.ImgUser);
    ...
    public class NearByAdapterViewHolder : RecyclerView.ViewHolder
    {
        ...
        public NearByAdapterViewHolder(View itemView, Action<NearByAdapterClickEventArgs> likeButtonClickListener, Action<NearByAdapterClickEventArgs> clickListener, Action<NearByAdapterClickEventArgs> longClickListener) : base(itemView)
        {
            try
            {
                ...
                //Event
                LikeButton.Click += (sender, e) => likeButtonClickListener(new NearByAdapterClickEventArgs { View = itemView, Position = AdapterPosition, Image = ImgUser });
                itemView.Click += (sender, e) => clickListener(new NearByAdapterClickEventArgs { View = itemView, Position = AdapterPosition, Image = ImgUser });
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
