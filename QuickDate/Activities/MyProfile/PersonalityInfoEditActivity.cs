        ...
        public void OnSelection(MaterialDialog p0, View p1, int itemId, ICharSequence itemString)
        {
            try
            {
                switch (TypeDialog)
                {
                    case "Character":
                    {
                        var characterArray = ListUtils.SettingsSiteList?.Character?.FirstOrDefault(a => a.ContainsValue(itemString.ToString()))?.Keys.FirstOrDefault();
                    ...
                    case "Children":
                    {
                        var childrenArray = ListUtils.SettingsSiteList?.Children?.FirstOrDefault(a => a.ContainsValue(itemString.ToString()))?.Keys.FirstOrDefault();
                    ...
                    case "Friends":
                    {
                        var friendsArray = ListUtils.SettingsSiteList?.Friends?.FirstOrDefault(a => a.ContainsValue(itemString.ToString()))?.Keys.FirstOrDefault();
                    ...
                    case "Pets":
                    {
                        var petsArray = ListUtils.SettingsSiteList?.Pets?.FirstOrDefault(a => a.ContainsValue(itemString.ToString()))?.Keys.FirstOrDefault();
